...
| 40%   69C    P0    N/A /  N/A |   1924MiB /  1999MiB |     N/A      Default |
+-------------------------------+----------------------+----------------------+
...
| Name                 | Meaning                            | Value            |
|----------------------+------------------------------------+------------------|
| NVIDIA-SMI           | NVIDIA System Management Interface | 430.26           |
| Driver Version       |                                    | 430.26           |
| CUDA Version         |                                    | 10.2             |
| GPU                  | Attached GPUs                      | 0                |
| Name                 | Product Name                       | GeForce GT 730   |
| Persistence-M        | Persistence Mode                   | off              |
| Fan                  | Fan Speed                          | 40%              |
| Temp                 | Temperature Gpu                    | 69C              |
| Perf                 | Performance State                  | P0               |
| Pwr: Usage/Cap       | Power: Usage/Cap                   | N/A N/A          |
| Bus-Id               |                                    | 00000000:01:00.0 |
| Disp.A               | Dispaly Active                     | N/A              |
| Memory-Usage         |                                    | 1924MiB/1999MiB  |
| Volative Uncorr. Ecc | ECC: error Correcting Code         | N/A              |
| GPU-Util             | Utilization                        | N/A              |
...
* df
#+BEGIN_SRC sh
df -T  # to see mount type
#+END_SRC

* lsblk
#+BEGIN_SRC sh
lsblk -f  # to see mount type
#+END_SRC

* mount
#+BEGIN_SRC sh
mount | grep media  # to see mount U file type
#+END_SRC

* e2label: used to rename U name with ext filesystem
#+BEGIN_SRC sh
sudo e2label /dev/sda2 hack
#+END_SRC
* dmidecode: to check base board information
