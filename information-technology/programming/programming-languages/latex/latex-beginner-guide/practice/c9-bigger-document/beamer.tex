...
\newenvironment{matrixtable}[4]{%
  \begin{tikzpicture}[matrix of nodes/.style={
    ...
    nodes={draw,top color=blue!10,bottom color=blue!35, draw,innersep=2pt,minimum height=3.1ex},
    columnsep=1ex,row sep=0.6ex,inner sep=2ex, roundedcorners,column 1/.style={minimum width=#1},
